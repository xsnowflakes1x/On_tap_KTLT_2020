...
void TinhTongCacPhanTu(int &n, int *iMang);
void TinhTrungBinhCacPhanTuOViTriLe(int &n, int iMang[]);
void TimPhanTuChanDuongVaNhoNhat(int &n, int iMang[]);
void InCacSoNguyenTo(int &n, int iMang[]);
void TimX(int &n, int *iMang);
...
void XuatViTri_X_CuoiCung(int &n, int *iMang);
void KiemTraMangCoDoiXung(int &n, int *iMang);
void DaoNguocMang(int &n, int *iMang);
void main()
{
...
void ChuongTrinhMangSoNguyen1Chieu()
{
	...
	cout << "Nhap vao N (so luong) phan tu cua mang 1-100: " << endl;
	cin >> n;
	NhapMang(n, iMang);
