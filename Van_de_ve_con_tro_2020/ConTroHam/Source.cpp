...
//void* tinh(int a); //<= Đây là hàm con trỏ nhóe! (có dấu gạch dưới màu xanh là chưa dc định nghĩa)
//void(*ConTroHam)(int &a, int &b); //=>con trỏ - Hàm(ko có dấu gạch dưới chứng tỏ đây là 1 con trỏ)
void main()
{
	cout << "aa";
	void (*tinh)(int &a, int &b); // void *tinh(int a);--> đây có phải con trỏ hàm không?
	tinh = &Hieu;					// => Không nó là hàm con trỏ. phải ghi vậy mới đúng nè: void* tinh(int a);
	int c = 5, d = 6, T = 0;
	cout << "\n Ket qua: "; (*tinh)(c, d);
	_getch();
}
